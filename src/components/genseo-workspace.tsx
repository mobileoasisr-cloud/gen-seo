    ...
    <main className="min-h-screen bg-slate-950 text-white">
            ...
            <div className="space-y-7">
              ...
              <div className="space-y-5">
                ...
                <p className="max-w-2xl text-lg leading-8 text-slate-300">
                  GenSEO now includes a local API, domain store, simulated AI/RAG
                  services, SEO scoring, internal links, API key rotation, and
                  WordPress draft sync controls.
                </p>
              </div>
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-6 px-6 py-12 lg:px-8">
        ...
        <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
          <Panel id="projects" eyebrow="Project" title="Project command center">
            {snapshot ? (
          ...
          <Panel id="api-keys" eyebrow="Settings" title="API key rotation">
            <div className="space-y-4">
              ...
              <ActionButton
                ...
                onClick={() => run({ type: "rotateApiKey", projectId })}
              >
        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          ...
          <Panel id="rag" eyebrow="RAG" title="Retrieved context">
        ...
        <Panel id="keyword-plan" eyebrow="Keyword Plan" title="Pillar-Cluster planner">
          <div className="space-y-5">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <Panel id="articles" eyebrow="AI writer" title="Article generation and SEO">
            <div className="space-y-5">
              <ActionButton
                disabled={!latestReadyCluster || isMutating}
                onClick={() =>
                  latestReadyCluster
                    ? run({
          ...
          <Panel id="internal-links" eyebrow="Automation" title="Internal linking">
            <div className="space-y-4">
              <ActionButton
                disabled={!snapshot || isMutating}
                onClick={() => run({ type: "scanInternalLinks", projectId })}
              >
                Scan internal links
              </ActionButton>
              <div className="space-y-3">
        ...
        <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
          <Panel id="wordpress" eyebrow="Publishing" title="WordPress sync">
            {latestArticle ? (
              <div className="space-y-4">
                <p className="text-sm leading-6 text-slate-300">
                  Latest article:{" "}
          ...
          <Panel id="jobs" eyebrow="Background jobs" title="Processing timeline">
            <div className="space-y-3">
